...
@tool("evaluate_title")
def evaluate_title_tool(title: str, content: str) -> str:
    ...
    """
    logger.info(f"Evaluating title with title: {title} and content: {content}...")
    ...
    prompt.append(HumanMessage(content=f"Title: {title}\nContent: {content}"))
